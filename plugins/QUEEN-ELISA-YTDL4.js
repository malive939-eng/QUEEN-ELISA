//plugin by ᴀʏᴀɴ ꜱᴇᴠᴇɴ ᴍᴏᴅᴢ ..... ❄️🪄

//Don't remove credit.. 🪄
// https://whatsapp.com/channel/0029Vb6KS7MGk1FnsSiliX0P

//  ⏤͟͟͞͞ ✰ QUEEN ELISA UPDATE https://whatsapp.com/channel/0029Vb6KS7MGk1FnsSiliX0P
...
cmd(
  ...
  async (robin, mek, m, { from, q, reply }) => {
    try {
      if (!q) return reply("*_GIVE ME THE VIDEO NAME OR URL_*");
      ...
      let desc = `
*_QUEEN ELISA VIDEO DOWNLOADER 🎬_*
...
2. Document Format 📁
   ...
   2.5 - 1080p
    ...
    ⏤͟͟͞͞ ✰ QUEEN ELISA DOWNLOAD ⏤͟͟͞͞ ✰
    ⏤͟͟͞͞ ✰ FOLLOW MY CHANNEL ⏤͟͟͞͞ ✰
    https://whatsapp.com/channel/0029Vb6KS7MGk1FnsSiliX0P
`;
        ...
        if (
          ...
          try {
            ...
            if (!validOptions.includes(selectedOption)) {
              ...
              return reply("*_Please reply with a valid option (e.g., 1.1, 2.3)._*");
            }
            ...
            if (!data || !data.download_url) {
              await robin.sendMessage(from, { react: { text: "❌", key: msg.key } });
              return reply("*_❌ Download link not found! Try again later._*");
            }
