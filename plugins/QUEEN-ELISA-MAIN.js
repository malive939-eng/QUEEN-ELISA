...
const listMessage = {
  ...
  image : { url : config.LOGO} ,
  footer: config.FOOTER,
  buttonText: "*_🔢 Reply below number,_*",
  sections,
  contextInfo: {
...
if(config.ALIVE === "default"){
 const sections = [
	...
	rows: [
        ...
        {title: "8", rowId: prefix + 'funmenu' , description: '●●►❮Fun commands❯'},
	]
    } 
]
const listMessage = {
  caption: `.    ╭─ׅ─ׅ┈ ─๋︩︪─☪︎︎︎̸⃘̸࣭ٜ࣪࣪࣪۬◌⃘۪֟፝֯۫۫︎⃪𐇽۫۬🍧⃘⃪۪֟፝֯۫۫۫۬◌⃘࣭ٜ࣪࣪࣪۬☪︎︎︎︎̸─ׅ─ׅ┈ ─๋︩︪─╮
╭╼☁️⬪࣪ꥈ𑁍⃪࣭۪ٜ݊݊݊݊݊໑ٜ࣪ Q U E E N - E L I S A ໑⃪࣭۪ٜ݊݊݊݊𑁍ꥈ࣪⬪☁️
┃֪࣪  ╰─ׅ─ׅ┈ ─๋︩︪─☪︎︎︎̸⃘̸࣭ٜ࣪࣪࣪۬◌⃘۪֟፝֯۫۫︎⃪𐇽۫۬🍧⃘⃪۪֟፝֯۫۫۫۬◌⃘࣭ٜ࣪࣪࣪۬☪︎︎︎︎̸─ׅ─ׅ┈ ─๋︩︪─╯
├ׁ̟̇❍✎ ${monspace}👋 කොහිමද ${pushname} I'm alive now${monspace}
├ׁ̟̇❍✎ *🚀Version:* ${require("../package.json").version}
├ׁ̟̇❍✎ *⌛Memory:* ${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)}MB / ${Math.round(require('os').totalmem / 1024 / 1024)}MB
├ׁ̟̇❍✎ *🕒Runtime:* ${runtime(process.uptime())}
├ׁ̟̇❍✎ *📍Platform:* ${hostname} 
...
const listMessage = {
  ...
  image : { url : config.LOGO} ,
  footer: config.FOOTER,
  buttonText: "*_🔢 Reply you select number,_*",
  sections,
  contextInfo: {
