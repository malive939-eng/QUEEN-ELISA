...
cmd(
  ...
  async (frozen, mek, m, { from, q, reply }) => {
    try {
      if (!q) return reply("*_GIVE ME THE SONG NAME OR URL_*");
      ...
      let desc = `
*_⏤͟͟͞͞ ✰© QUEEN ELISA SONG⏤͟͟͞͞ ✰_*
...
🔢 *_Reply with a number to select format:_*
1. Audio Format 🎶
2. Document Format 📁
3. Voice Note Format 🎙️

*_⏤͟͟͞͞ ✰©MADE BY QUEEN ELISA⏤͟͟͞͞ ✰_*
                        👸💋
`;
