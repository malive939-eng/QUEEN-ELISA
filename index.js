...
console.log('Queen Elisa connected to whatsapp ✅')
    }
  })
...
mediaType: 1,
sourceUrl: "https://wa.me/258871168283" ,
...
body: 'ᴀ ꜱɪᴍᴘʟᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ',
mediaType: 1,
sourceUrl: "https://wa.me/258871168286" ,
thumbnailUrl: 'https://files.catbox.moe/0xh1qr.jpg' ,
renderLargerThumbnail: false,
showAdAttribution: true
}
...
body: 'ᴀ ꜱɪᴍᴘʟᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ʙᴏᴛ',
mediaType: 1,
sourceUrl: "https://wa.me/258833406646" ,
thumbnailUrl: 'https://files.catbox.moe/0xh1qr.jpg' ,
renderLargerThumbnail: false,
showAdAttribution: true
}
...
app.get("/", (req, res) => {
  res.send("📟 Queen Elisa Working successfully!");
});
app.listen(port, () => console.log(`Queen Elisa Server listening on port http://localhost:${port}`));
setTimeout(async() => {
  await connectToWA()
}, 1000);
